...
const BookCard = ({ title, author, description, language, imageUrl, videoUrl }) => (
    <div className="mb-6 overflow-hidden rounded-lg shadow-md">
        ...
        <div className="p-4 bg-white">
            ...
            <p className={`text-sm ${language === 'en' ? 'font-serif' : 'font-sans'} mb-4`}>{description}</p>
            <div className="flex justify-center">
                <video className="w-1/2 rounded" controls>
