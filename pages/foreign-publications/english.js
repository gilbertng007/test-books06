...
const books = [
  ...
  },
  {
    ...
    cover: "/placeholder.svg?height=400&width=300&text=Brave+New+World",
    rating: 4.5,
    pages: 311,
    price: 11.99,
    images: [
      "/placeholder.svg?height=200&width=300&text=Futuristic+City",
      "/placeholder.svg?height=200&width=300&text=Laboratory",
    ],
